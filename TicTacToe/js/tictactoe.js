...
function placeXOrO(squareNumber) {
    //this condition entures a square hasn't been selected already
    ...
    if (!selectedSquares.some(element=>element.includes(squareNumber))) {
        ...
        if (activePlayer==='X') {
            //uf active player is 'X' change it to 'O'
            activePlayer='O';
...
function disableClick() {
    ...
    //this makes our body clickable againafter 1 second
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    ...
    //this line indicates where the state of a lines x-axis is
    let x1=coordX1,
